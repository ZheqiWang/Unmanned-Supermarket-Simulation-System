...
namespace 无人超市PC管理端
{
    public partial class Login : Form
    {
        ...
        private void loginBtn_Click(object sender, EventArgs e)
        {
            ...
            string s1 = "select 登录名,登录密码 from 员工表 where 登录名='" + username + "' and 登录密码='" + pw + "'";                                            //编写SQL命令
            ...
            int n = myDA.Fill(myDS, "员工表");              //将结果放入数据适配器，返回元祖个数
        ...
        private void checkCode_Click_1(object sender, EventArgs e)
        {
